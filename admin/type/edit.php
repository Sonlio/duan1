                ...
                <div class="content-panel">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input class="readonly form-control" type="text" name="id_type" id="id_type" readonly value="1">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name_type">Tên loại <strong>*</strong></label>
                            <input type="text" class="form-control" name="name_type" id="name_type" placeholder=" " value="Đồng hồ nam"> <br>
