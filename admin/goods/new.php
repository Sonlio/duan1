                ...
                <div class="content-panel">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input class="readonly form-control" type="text" name="id_product" id="id_product" readonly value="Auto number">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name_product">Tên đồng hồ <strong>*</strong></label>
                            <input type="text" class="form-control" name="name_product" id="name_product" placeholder=" "> <br>
                            <label for="" class="label-field">Tên đồng hồ</label>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="price_product">Đơn giá <strong>*</strong></label>
                            <input type="text" class="form-control" name="price_product" id="price_product" placeholder=" "> <br>
                            <label for="" class="label-field">Giá</label>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="discount_product">Giảm giá <strong>*</strong></label>
                            <input type="text" class="form-control" name="discount_product" id="discount_product" placeholder=" "> <br>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="describe_product" id="describe_product" rows="5" placeholder=" "></textarea> <br>
