                ...
                <div class="content-panel">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input class="readonly form-control" type="text" name="id_brand" id="id_brand" readonly value="1">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name_brand">Tên hãng <strong>*</strong></label>
                            <input type="text" class="form-control" name="name_brand" id="name_brand" placeholder=" " value="Rolex"> <br>
